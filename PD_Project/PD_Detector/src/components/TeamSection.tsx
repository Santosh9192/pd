...
const TeamSection = () => {
  const team = [
    {
      name: "Santosh Babar",
      role: "Backend Developer, ML Engineer & Data Scientist",
      description:
        "Specialized in machine learning model development, Flask API integration, data analysis and model optimization.",
      initials: "SB",
    ...
    },
    {
      ...
      description:
        "Expert in creating beautiful and responsive user interfaces while designing intuitive and accessible healthcare interfaces.",
      initials: "PN",
